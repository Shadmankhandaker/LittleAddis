...
import 'package:love/ENG/block/signup_bloc.dart';
...
class SignUpState extends State<SignUpScreen>
  ...
  //final FocusNode _phoneController = FocusNode();
  ProgressDialog? pr;
  ...
  void _signup(BuildContext context) {
    ...
    if (_firstnameController.text.isNotEmpty) {
      if (_lastnameController.text.isNotEmpty &&
          ...
          signupBloc
            ...
            (userResponse) {
              if (userResponse.message == null) {
                ...
                errorDialog(
                  context,
                  "You succesfully created account, please sign in to continue.",
                  button: true,
                );
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => LogInScreenEng()),
                );
        ...
        pr?.hide();
        errorDialog(context, "Please enter valid credential to sign up");
      }
    } else {
      pr?.hide();
      errorDialog(context, "Please enter valid credential to sign up");
