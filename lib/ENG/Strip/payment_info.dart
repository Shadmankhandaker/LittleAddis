...
import 'package:love/ENG/block/deletecart_bloc.dart';
...
class PaymentInformation extends StatefulWidget {
  ...
  _PaymentInformationState createState() => _PaymentInformationState(
      ...
      '',
      orderid,
      this.model ?? OrdersResponseModel());
}
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: _buildTitle("PAYABLE AMOUNT"),
                                  ),
                                ),
                                Expanded(
                                  child: Padding(
            ...
            child: SizedBox(
              ...
              child: RaisedButton(
                ...
                onPressed: () {
                  ...
                  double totalAmountDouble = double.parse(pay ?? "0");
    ...
    bloc
      ...
      if (value != null) {
        if (value.success == 200) {
          errorDialog(context, "Payment Done Successfully");
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MyHomeEng(from: "Order Done")),
          );
        } else {
          errorDialog(context,
              "Error Occurred.Complete your payment from Orders History");
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => MyHomeEng(from: "Order Done")),
        ...
        errorDialog(context, "Unable to make payment");
      }
    });
  }
