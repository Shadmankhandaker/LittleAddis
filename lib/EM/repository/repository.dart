...
import '../../ENG/model/profile_modal.dart';
import '../../ENG/model/recipe_response_model.dart';
import '../../ENG/model/repeatOrder_model.dart';
import '../../ENG/model/search_model.dart';
import '../../ENG/model/updateCart_model.dart';
import '../../ENG/model/updateprofile2_model.dart';
import '../../ENG/model/updateprofile_model.dart';
import '../../ENG/model/userorders_model.dart';
import '../../ENG/provider/address_api.dart';
import '../../ENG/provider/addtocart_api.dart';
import '../../ENG/provider/allproduct_api.dart';
import '../../ENG/provider/blog_api.dart';
import '../../ENG/provider/checkout_api.dart';
import '../../ENG/provider/deletecart_api.dart';
import '../../ENG/provider/getAddress_api.dart';
import '../../ENG/provider/google_api.dart';
import '../../ENG/provider/login_api.dart';
import '../../ENG/provider/profile_api.dart';
import '../../ENG/provider/recipe_api.dart';
import '../../ENG/provider/reorder_api.dart';
import '../../ENG/provider/search_api.dart';
import '../../ENG/provider/signup_api.dart';
import '../../ENG/provider/updateCart_api.dart';
import '../../ENG/provider/updatepro2_api.dart';
import '../../ENG/provider/updatepro_api.dart';
import '../../ENG/provider/userorders_api.dart';
...
import '../../models/signup/sign_up_body.dart' as signupBody;
import '../../models/signup/sign_up_body.dart';
import '../../models/signup/sign_up_response_model.dart';
import '../../models/validate_token/token_validate_response_model.dart';
...
class Repository {
  ...
  Future<SignUpResponseModel> signupRepository(String username, String email,
  ...
  Future<List<AllProductsResponseModel>> allProductRepository() async {
    return await AllProductApi().productApi(0);
  }
